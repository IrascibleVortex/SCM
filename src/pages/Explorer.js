...
export default function Explorer(props) {
  ...
  if (productData.length !== 0) {
    ...
    Manufactured date: ${new Date(
      parseInt(productData[1][0] * 1000)
    ).toLocaleString()}
    Details of Manufacturer: ${productData[0][5]}
    Longitude of Manufacturer: ${productData[0][6]}
    Latitude of Manufacturer: ${productData[0][7]}
    
    Product Name: ${productData[1][1]}
    Product Code: ${productData[1][2]}
    Product Price: ${productData[1][3]}
    Product Category: ${productData[1][4]}
    Product State: ${productData[1][5]}
    
    Third Party Details:
    Address: ${productData[1][6]}
    Longitude: ${productData[1][7]}
    Latitude: ${productData[2][0]}
    
    Delivery Hub Details:
    Address: ${productData[2][1]}
    Longitude: ${productData[2][2]}
    Latitude: ${productData[2][3]}
    
    Customer Details:
    Address: ${productData[2][4]}
    
    Transaction Details:
    Tx Hash: ${productData[2][5]}`.replace(/\n/g, "");
  }
